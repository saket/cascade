...
//  var popupPosition by remember { mutableStateOf(null as IntOffset?) }
...
//
//  LaunchedEffect(Unit, popupPosition) {
//    if (popup.isShowing && popupPosition != null) {
//      println("Moving popup to $popupPosition")
//      popup.update(
//        /* anchor = */ hostView,
//        /* xoff = */ popupPosition!!.x,
//        /* yoff = */ popupPosition!!.y,
//        /* width = */ -1,
//        /* height = */ -1
//      )
